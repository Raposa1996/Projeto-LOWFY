...
const About = () => {
  return (
    <div className="about-page">
      ...
      <p>
        Este é um simples reprodutor de música construído com React. Ele permite que você ouça músicas diretamente em seu navegador, com integração a APIs de música como o YouTube.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Integração com APIs de música como o YouTube (em uma versão futura)</li>
      </ul>
      <p>
